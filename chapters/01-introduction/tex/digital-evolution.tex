...
% @AML: ([note that this is also true to some extent in experimental evolution with biological organisms/this is a common criticism of laboratory experimental evolution too])
...
% Experiments with digital organisms are limited to testing general principles about evolution.
...
%  (as is relevant to this dissertation)

% --------- HISTORICAL CONTEXT ---------
\subsection{Historical context}
% Other headings:
% - A brief history of evolving self-replicating computer programs
...
% Some programs achieved success by engaging in rapid self-replication.
% @AML: double check accuracy of this sentence:
...
% daughter programs were always exact copies of their parent (i.e., [no mutations/heritable variation]).

% --- Core World ---
% @AML: a little clunky, needs streamlining
Inspired by Core War, Rasmussen \textit{et al.} created Core World \citep{rasmussen_core_1989}.
...
% mutations in daughter programs are less often lethal.
...
Resources in Avida are associated with completing designated tasks, such as computing Boolean logic functions on inputs from the environment. % or [...].
...
% @AML: I feel like I need to say the next line somewhere here, but it currently doesn't flow well.
...
% @AML: [Something about how digital evolution systems are individual-based and why that is useful?]
...
% @AML: carbon-based life language is from wilke & adami 2002, I don't love it here. 
...
% -- Knockout analyses --
% @AML: This might be too much detail for this section! 
...
We can then express each possible mutant, characterizing any phenotypic differences between it and the [original] genotype. %its phenotype and self-replication rate relative to the original.
...
\subsubsection{Scale}
% @AML: This section needs more examples if possible.
...
% @AML: Alternative headings
% - Phenotypically plastic digital organisms
