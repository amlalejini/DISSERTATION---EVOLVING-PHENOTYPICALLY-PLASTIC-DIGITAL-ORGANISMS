...
\renewcommand{\arraystretch}{1.5}
    ...
    ``Plastic Replicates'' indicates the number of replicates (out of 50 per treatment) in which the final dominant genotype was plastic at all (``Total'') and perfectly plastic (``Optimal'').  
